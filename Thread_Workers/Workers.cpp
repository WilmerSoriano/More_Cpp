/*
  Code is under debugging, comments are here to help
  get an idea of what the project is about
*/
...
// a. Declare a global vector of Work objects named “work”
        std::vector<Work> work;



// b. Declare an iterator for “work” named “next_work”
//     (Remember, class "iterator" is nested within the container)
//     It will be initialized in main, so don’t initialize here



// c. Declare a mutual exclusion object named “m”, which will
...
// d. Lock mutual exclusion object “m” to block other threads
//     from this region while this thread executes it


// e. Use next_work’s copy constructor to create an iterator
...
// f. Unlock mutual exclusion object “m”
...
int main() {
  ...
  // g. Initialize the “next_work” iterator to point to
  //     the first element of vector “work”




  // h. Create and run 10 threads, each running “worker”,
  //     and storing them in an array or vector named “threads”




  // i. Join the 10 threads as they complete
